...
function Activity() {
    ...
    return (
      <div className='case-studies'>
        ...
        <h3 className='subsection-font'>What contributes to stagnation in activity levels?</h3>
        ...
        <h3 className='subsection-font'>How can we relieve this stagnation?</h3>
        <ol className='alpha-list'>
        ...
        <h3 className='subsection-font'>Movement within task management and habit trackers.</h3>
        ...
        <div className='app-screen-container'>
          <img className='app-screen-50' src={img4} alt='journaling in the app'></img>
          <img className='app-screen-50' src={img5} alt='journaling on paper'></img>
        </div>

        <h3 className='subsection-font'>How might we track workouts the same way we track our tasks or habits?</h3>
        ...
        <div className='app-screen-container'>
          <img className='app-screen-50' src={img6} alt='app - activity scheduler'></img>
          <img className='app-screen-50' src={img7} alt='app - activity scheduler'></img>
        </div>

        <h3 className='subsection-font'>How might we create a new habit while tracking progress?</h3>
        ...
        <div className='app-screen-container'>
          <img className='quarter-img' src={img8} alt='app - dashboard mockup'></img>
          <img className='quarter-img' src={img9} alt='app - dashboard mockup'></img>
          <img className='half-img' src={img10} alt='app - dashboard mockup'></img>
        </div>

        <h3 className='subsection-font'>Pandemic and compromises.</h3>
